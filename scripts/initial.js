...
// myToken.snatch(2, {from:web3.eth.accounts[1], value: 5});
// web3.fromWei(web3.eth.getBalance(web3.eth.accounts[0]));
// myToken.getToken(2);
// curl -d "{"jsonrpc":"2.0","method":"eth_sendTransaction","params": [{"from":"0x198e13017d2333712bd942d8b028610b95c363da", "to":"0xa93b8C89d89dc5fe774141eF959A71629EefbdF9", "value": 1e18}], "id":1}" -X POST http://127.0.0.1:8545/
